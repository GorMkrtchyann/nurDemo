            ...
            list: [
                {
                    title: "Ձվածեղ",
                    subMenu: [
                        {name: "Ձվածեղ", info: null, price: 800},
                        {name: "պանրով, կանաչիներով", info: '3 ձու, պանիր, թարմ խառը հայկական կանաչի, կարագ', price: 1500},
                        {name: "բաստուրմայով, սուջուխով", info: '3 ձու, բաստուրմա, սուջուխ, կարագ', price: 2000},
                        {name: "լոլիկով", info: '3 ձու, լոլիկ, կծու պղպեղ, կարագ', price: 1500},
                    ]
                },
                {
                    title: "Նյու-Յորք",
